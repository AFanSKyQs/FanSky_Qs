...
export class UpdatePlugin extends plugin {
    ...
    async AFanSKyQsHelp(e) {
        ...
        if(SignDay[e.user_id]){HelpList.push(`QQ：${e.user_id}\n魔晶：${SignDay[e.user_id].rough}\n已打卡：${SignDay[e.user_id].day}天 | 连续：${SignDay[e.user_id].continuous}天 | ${SignDay[e.user_id].count}次\n首次打卡时间：\n${(new Date(SignDay[e.user_id].FirstSignTime)).toLocaleString()}`)}else{HelpList.push(`QQ：${e.user_id}\n魔晶：0\n已打卡：0天 | 连续：0天 | 0次\n首次打卡时间：未打卡\n可发送【打卡】或【冒泡】打卡`)}
