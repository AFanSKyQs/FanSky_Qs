...
## `提瓦特小助手伤害计算评级系统`和`【打卡-魔晶系统】`正在开发中，如有兴趣欢迎联系加入开发，资源文件已经具备....

### OpenAI现在需要设置代理使用，有问题请入群艾特我一下，免费解决问题和提供一些东西[755794036](https://jq.qq.com/?_wv=1027&k=I2HCxKdM)，使用只需要Clash挂一个非大陆节点开启即可，不用其他的设置，插件内设置了代理走的Clash端口

## 一、FanSky_Qs说明

`FanSky_Qs`是`Yunzai-Bot`的扩展插件，提供部分群聊等小功能小游戏。

`提瓦特小助手伤害计算评级`、`GPT-3.5模型记忆聊天`、`切换多模型`、`设置模型人设`、`设置模型打卡绑定`、`设置模型模式`、`发病`、`接入AI问候`、`电影票房`、`打卡、冒泡`、`QQ名片点赞`

`拉黑语言模型使用者`、`一眼丁真`等后续功能持续围绕 `【打卡-魔晶系统】` 开发中....
